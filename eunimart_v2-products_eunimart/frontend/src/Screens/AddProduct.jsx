...
import Delivery from "../components/AddProduct/Common/ProductDetails/Delivery";
import Pricing from "../components/AddProduct/Common/ProductDetails/Pricing";
import ProductInfo from "../components/AddProduct/Common/ProductDetails/ProductInfo";
import ManufacturerDetails from "../components/AddProduct/Common/ProductDetails/ManufacturerDetails";
import Location from "../components/AddProduct/Common/ProductDetails/Location";
import Cancellation from "../components/AddProduct/Common/ProductDetails/Cancellation";
import Returns from "../components/AddProduct/Common/ProductDetails/Returns";
import FoodItem from "../components/AddProduct/Common/CreateVariant/FoodItem";
import Replacement from "../components/AddProduct/Common/ProductDetails/Replacement";
import InventoryDetailsCard from "../components/AddProduct/Common/ProductDetails/InventoryDetailsCard";
import { getFullFillData } from "../redux/Action/CombinedActions";
// import FoodItem from "../components/AddProduct/Common/CreateVariant/FoodItem";
...
function AddProduct({ edit }) {
  ...
  const step1Validation = () => {
    console.log("step1Data", step1Data, finalData, step3Data);
    console.log("testnull", step1Data?.unit_per_box);
    // if (
    ...
    // step1Data?.commodity_name === undefined ||
    // step1Data?.manufacturer_address === undefined ||
    // step1Data?.manufacturer_date === undefined ||
    // step1Data?.manufacturer_name === undefined ||
    // step1Data?.net_quantity === undefined  ||

    // step1Data?.unit_per_box === undefined ||
    // step1Data?.time_to_ship === undefined ||
    // step1Data?.consumer_care_number === undefined ||

    // step1Data?.mrp === undefined ||
    // step1Data?.sales_price === undefined  ||
    // step1Data?.currency_id === undefined ||
    // step1Data?.declared_price === undefined  ||
    // step1Data?.payment_method_id === undefined  ||

    // step1Data?.address_line1 === undefined ||
    // step1Data?.address_line2 === undefined  ||
    // step1Data?.address_line3 === undefined ||
    // step1Data?.pincode === undefined  ||
    // step1Data?.state_id === undefined  ||
    // step1Data?.city === undefined  ||

    // step1Data?.estimated_delivery_time_id === undefined ||
    // step1Data?.address_line2 === undefined  ||
    // step1Data?.address_line3 === undefined ||
    // step1Data?.pincode === undefined  ||
    // step1Data?.state_id === undefined  ||
    ...
    // step3Data?.package_dimensions?.package_height === undefined ||
    // step3Data?.package_dimensions?.package_length === undefined ||
    // step3Data?.package_dimensions?.package_weight === undefined ||
    // step3Data?.package_dimensions?.volumetric_weight === undefined ||
    // step3Data?.package_dimensions?.packaging_type === undefined
    ...
    if (activeStep === 1) {
      setTimeout(() => {
        if (edit) {
          ...
          console.log("hyhy", finalData);

          dispatch(postCreateProduct(finalData));
        }
      }, 0);
      history("/ondcProducts");
    }
    // if (
