...
import ProductDetailsMDM from "../components/AddProduct/Common/ProductDetails/ProductDetails_mdm";
import CategoryDetailsMDM from "../components/AddProduct/Common/CategoryDetails/CategoryDetails_mdm";

function AddProductMDM({ edit }) {
