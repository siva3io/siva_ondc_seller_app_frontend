...
import DeliverySLADetailsCard from "../components/ProductView/Variant/DeliverySLADetails";
import FoodItemDetailsCard from "../components/ProductView/Variant/FoodItemsDetails";
import LocationPricingDetailsCard from "../components/ProductView/Variant/LocationPricingDetails";
import PaymentCancellationDetailsCard from "../components/ProductView/Variant/PaymentCancelationDetails";
import ManufacturerDetailsCard from "../components/ProductView/Variant/ManufacturerDetails";
import ProductInventoryDetailsCard from "../components/ProductView/Variant/InventoryDetails";
import DeliverSLA from "../components/ProductView/Variant/DeliverySLA";
import PricingONDC from "../components/ProductView/Variant/PricingONDC";
import ReturnDetailsONDC from "../components/ProductView/Variant/ReturnDetailsONDC";
        ...
        <Box className="productDetails_main">
          <Box className="product_detail_menu_card">
            <Box className="header_action">
              ...
              <Box className="actionButtonBlock"></Box>
            </Box>
              ...
              {access
                ...
                activeTab && (
                  <Button
                    sx={{
                      background:
                        activeTab === "Omnichannel" ? "#f2f5fe" : "#fff",
                    }}
                    onClick={() => {
            ...
            {activeTab && activeTab === "Omnichannel" ? (
              ...
              <>
                ...
                {/* <ExtraVariantDetailsCard
                  ...
                  prod_id={id}
                  updateFields={updateFields}
                  cardTitle={"Extra Variant Information"}
                  edit={edit}
                  parentBrand={brand}
                  access={access}
                /> */}
                ...
                />
                  <ManufacturerDetailsCard
                      fields={
                        variantDetailsArr && variantDetailsArr[varientTabNo]
                      }
                      prod_id={id}
                      updateFields={updateFields}
                      cardTitle={"ManuFacurer Details"}
                      edit={edit}
                      access={access}
                    />
                ...
                />
                    ...
                    <ProductInventoryDetailsCard
                      ...
                      access={access}
                    />
                    <PaymentCancellationDetailsCard
                      fields={
                        variantDetailsArr && variantDetailsArr[varientTabNo]
                      }
                      prod_id={id}
                      updateFields={updateFields}
                      cardTitle={"Payment Cancellation Terms"}
                      edit={edit}
                      access={access}
                    />
                    <ReturnDetailsONDC
