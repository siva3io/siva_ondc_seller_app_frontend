...
function Delivery({
  ...
  const [staticFields, setStaticFields] = useState([
    {
      ...
      data: [],
      required: true,
      key: "estimated_delivery_time_id",
      value: "",
    },
    // {
  ...
  const onSelectionChanges = (prop, valueId, valueLabel) => {
    ...
    if (valueId !== "create") {
      ...
      setFinalData({ ...finalData, delivery_sla_details: { ...tempAttribute, [prop]: valueId } });
    }
  };
  ...
  const onInputChange = (prop, value) => {
    ...
    setFinalData({ ...finalData, delivery_sla_details: { ...tempAttribute, [prop]: value } });
  };
      ...
      <div className="locationDetailForm">
        {brand && (
          <div className="staticFormCard">
            <div className="staticFormCardTitle">Delivery SLA</div>
