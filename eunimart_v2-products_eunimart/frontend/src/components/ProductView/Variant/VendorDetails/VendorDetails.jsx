...
const VendorDetails = ({ fields, edit, access }) => {
  //redux
  ...
  const sendData = vendor => {
    console.log("data in send", vendor.price_list_details[0].id);
  ...
  useEffect(() => {
    setVendor(vendor);
    console.log("updated_Vendor", vendor);
  }, [vendor]);
