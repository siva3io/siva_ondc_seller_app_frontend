...
const ProductInventoryDetailsCard = ({ fields, edit, parentBrand, access }) => {
  ...
  const onInputChange = (prop, value) => {
    const newVariant = { ...variant.inventory_detail };
    const newFinalVariant = { ...finalVariant };


  newVariant[prop] = value;
  newFinalVariant["inventory_detail"] = { ...newFinalVariant["inventory_detail"],[prop]:Number(value)};

  setVariant((varb)=> {return {...varb,inventory_detail:newVariant} });
              ...
              <Suspense fallback={<div>Loading... </div>}>
                <RemoteWrapper>
                  <RemoteViewTextField
                    ...
                    text={
                      variant?.inventory_detail
                        ? variant?.inventory_detail?.available_quantity
                          ? variant?.inventory_detail?.available_quantity
                          : "--"
                        : "--"
                    }
              ...
              <Suspense fallback={<div>Loading... </div>}>
                <RemoteWrapper>
                  <RemoteViewTextField
                    ...
                    text={
                      variant?.inventory_detail
                        ? variant?.inventory_detail?.maximum_quantity
                          ? variant?.inventory_detail?.maximum_quantity
                          : "--"
                        : "--"
                    }
...
export default ProductInventoryDetailsCard;
