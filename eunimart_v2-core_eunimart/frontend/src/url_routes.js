...
import HomeRedirection from "./Screens/HomeRedirection";
      ...
      return (
        ...
        <Router history={history}>  
            ...
            <Route exact path="/home">
                <HomeRedirection setSessionId={setSessionId} />
              </Route> 
            <Route exact path="/storeFront">
                <Buyer setSessionId={setSessionId} />
            </Route> 
            <Route exact path="/notification">
                <Notifications />
            </Route>  
           {/*  <Route exact path="/home/deliveryOrderslist">
